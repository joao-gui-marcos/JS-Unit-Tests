...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(Object.keys(objetoRetornado)[0]).toBe('fetchMenu');
    // ```
    ...
    expect(objetoRetornado1.fetchMenu).toEqual({ food: {}, drink: {}})
    ...
    expect(objetoRetornado2.fetchMenu).toEqual({})
    // ```
    ...
    expect(objetoRetornado4.consumption).toEqual(["coxinha", "coxinha", "agua", 'sopa', 'sashimi'])
    // ```
    ...
    objetoRetornado.order('coxinha');
    expect(objetoRetornado.consumption).toEqual(["coxinha", "coxinha", "agua", 'sopa', 'sashimi','coxinha', 'agua', 'coxinha'])
    // ```
    ...
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    const menu1 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 5.5}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    expect(menu1.pay()).toBe(38.8)
    menu1.order('sashimi')
    expect(menu1.pay()).toBe(44.3)
    // ```
